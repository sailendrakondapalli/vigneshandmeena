...
export const translations = {
  en: {
    ...
    invitation_groomJob: 'Assistant Manager, Honda Cars India Limited',
    invitation_brideJob: 'Assistant Professor, Deshbandhu College, University of Delhi',
    ...
    event_heading: 'Event Schedule',
    event_tapHint: 'Tap each card to discover more',
    event_engTitle: 'Engagement',
    event_engDate: '01 July 2026 · Wednesday',
    event_engTime: '6:30 PM – 7:30 PM',
    event_muhTitle: 'Muhurtham',
    event_muhDate: '02 July 2026 · Thursday',
    event_muhTime: '4:30 AM – 6:00 AM',
    event_recTitle: 'Reception',
    event_recDate: '02 July 2026 · Thursday',
    event_recTime: 'From 7:00 PM onwards',
    event_venueShort: 'Sri Andavar Thirumana Mahal A/C, Tirupur',
...
M. Vignesh B.E (Mech). & S. Meena M.Com.`,
  ...
  ta: {
    ...
    invitation_groomJob: 'உதவி மேலாளர், Honda Cars India Limited',
    invitation_brideJob: 'உதவிப் பேராசிரியர், Deshbandhu College, Delhi பல்கலைக்கழகம்',
    ...
    event_heading: 'நிகழ்வு அட்டவணை',
    event_tapHint: 'மேலும் தெரிந்துகொள்ள அட்டையை தட்டவும்',
    event_engTitle: 'நிச்சயதார்த்தம்',
    event_engDate: '01 ஜூலை 2026 · புதன்',
    event_engTime: 'மாலை 6:30 – 7:30 மணி',
    event_muhTitle: 'முகூர்த்தம்',
    event_muhDate: '02 ஜூலை 2026 · வியாழன்',
    event_muhTime: 'அதிகாலை 4:30 – 6:00 மணி',
    event_recTitle: 'வரவேற்பு விழா',
    event_recDate: '02 ஜூலை 2026 · வியாழன்',
    event_recTime: 'மாலை 7:00 மணி முதல்',
    event_venueShort: 'ஸ்ரீ அண்டவர் திருமண மஹால் A/C, திருப்பூர்',
