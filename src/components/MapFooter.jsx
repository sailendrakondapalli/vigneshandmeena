...
function SyvenCredit() {
  return (
    <div style={{
      ...
      <p style={{
        color: 'rgba(212,175,55,0.7)', fontFamily: 'Lato,sans-serif',
        fontSize: 'clamp(9px,1.6vw,11px)', letterSpacing: '0.3em',
      ...
      >
        <svg viewBox="0 0 24 24" width="30" height="30" fill="none" style={{ flexShrink: 0 }}>
          <defs>
            <linearGradient id="ig-syven" x1="0%" y1="100%" x2="100%" y2="0%">
          ...
          <rect x="1" y="1" width="22" height="22" rx="6" ry="6" fill="url(#ig-syven)"/>
      ...
      <p style={{
        color: 'rgba(255,255,255,0.65)', fontFamily: 'Lato,sans-serif',
        fontSize: 'clamp(10px,1.8vw,12px)', letterSpacing: '0.2em',
      ...
      <p style={{
        color: 'rgba(212,175,55,0.45)', fontFamily: 'Lato,sans-serif',
        fontSize: 'clamp(8px,1.3vw,10px)', letterSpacing: '0.15em',
...
export default function MapFooter() {
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ width: '100%', maxWidth: '960px', margin: '0 auto', padding: 'clamp(48px,8vw,80px) clamp(16px,5vw,40px)' }}>
          ...
          <motion.div style={{ display: 'flex', justifyContent: 'center', marginBottom: 'clamp(32px,5vw,56px)' }} {...fadeUp(0.25)}>
            <a href="https://www.google.com/maps/search/Sri+Andavar+Thirumana+Mahal+Tirupur+Tamil+Nadu"
              target="_blank" rel="noopener noreferrer"
              style={{
                display: 'inline-flex', alignItems: 'center', gap: '10px',
                padding: 'clamp(10px,2vw,14px) clamp(24px,4vw,40px)',
                borderRadius: '999px', background: 'linear-gradient(135deg,#b8860b,#d4af37)',
      ...
      {/* SyvenCredit is OUTSIDE the footer — not affected by section-highlight opacity */}
      <SyvenCredit />
    </>
  )
}
