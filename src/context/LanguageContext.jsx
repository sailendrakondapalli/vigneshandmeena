...
M. Vignesh B.E (Mech). & S. Meena M.Com.`,
  ...
  ta: {
    ...
    gate_groomName: 'ம. விக்னேஷ்',
    gate_groomQual: 'பி.இ (மெக்.).',
    gate_brideName: 'ச. மீனா',
...
ம. விக்னேஷ் பி.இ (மெக்.). & ச. மீனா எம்.காம்.`,
    ...
    relatives_groomName: 'ம. விக்னேஷ்',
    relatives_groomQual: 'பி.இ. (மெக்.)',
    relatives_with: 'உடன்',
    relatives_brideName: 'ச. மீனா',
    ...
    relatives_names: 'ம. விக்னேஷ் & ச. மீனா',
    ...
    map_names: 'ம. விக்னேஷ் பி.இ (மெக்.). & ச. மீனா எம்.காம்.',
