      ...
      {stage === 'main' && (
        <motion.button onClick={toggleMusic}
          ...
          style={{
            ...
            background: musicOn ? 'linear-gradient(135deg,#b8860b,#d4af37)' : 'rgba(255,255,255,0.95)',
      ...
      {stage === 'main' && (
        <motion.button onClick={toggleLang}
          ...
          style={{
            ...
            fontFamily: 'Lato, sans-serif',
            background: lang === 'ta' ? 'linear-gradient(135deg,#8b1a2f,#c0404a)' : 'rgba(255,255,255,0.95)',
          ...
          <svg viewBox="0 0 24 24" width="12" height="12" fill="currentColor" opacity="0.85">
